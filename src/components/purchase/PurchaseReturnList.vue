  ...
  <div class="deliverlist">
    ...
    <div class="deliverlist-mian">
      ...
      >
        ...
        <el-table-column prop="buyerName" label="采购人员" width="200" />
        <el-table-column
          prop="offersPrice"
          label="优惠后应收款(元)"
          width="200"
        />
        <el-table-column prop="vettingState" label="出库状态" width="200">
          <template #default="scope">
...
export default {
  ...
  methods: {
    ...
    findpage() {
      ...
      var _this = this
      this.axios({
        url: 'http://localhost:8088/frameproject/purchaseReturn/conditionpage',
        method: 'post',
        data: {
