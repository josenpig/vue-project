...
export default {
  ...
  methods: {
    ...
    sum() {
      ...
      this.axios({
        url:
          'http://localhost:8088/frameproject/ReportFormController/fundAllRsumAndPsum',
        method: 'get',
        processData: false,
        params: fd,
        headers: {
    ...
    count() {
      ...
      this.axios({
        url:
          'http://localhost:8088/frameproject/ReportFormController/fundAllCount',
        method: 'get',
        processData: false,
        headers: {
          JWTDemo: state.userInfo.token,
    ...
    findpagePro() {
      ...
      this.axios({
        url:
          'http://localhost:8088/frameproject/ReportFormController/findAllProductInventoryVo',
        method: 'get',
        params: {
...
.workbench .clearfix:before,
.workbench .clearfix:after {
  display: table;
  content: '';
  line-height: 10px;
}
...
.workbench .el-dropdown-link {
  cursor: pointer;
  color: #409eff;
}

.workbench .el-card__header {
  line-height: 10px;
  /*text-align: left;*/
  /*width: 200px;*/
}

.workbench .ik-pull-right {
  margin-top: -5px;
  float: right;
}

.workbench .stats__badge {
  min-width: 54px;
  line-height: 20px;
  text-align: center;
  margin-left: 10px;
