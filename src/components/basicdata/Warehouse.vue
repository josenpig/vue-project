		...
		<div class="Warehouse-mian">
			<el-table :data="tableData" style="width: 100%" max-height="400" @selection-change="handleSelectionChange" border
			 stripe>
				...
				<el-table-column prop="date" fixed label="修改状态" width="120">
					<template #default="scope">
				...
				<el-table-column prop="depotId" fixed label="仓库编号" sortable width="140" />
				<el-table-column :show-overflow-tooltip="true" prop="depotName" label="仓库名称" sortable width="180" />
				<el-table-column :show-overflow-tooltip="true" prop="depotAddress" label="仓库地址"  width="150" />
				<el-table-column :show-overflow-tooltip="true" prop="chargeName" label="负责人" sortable width="120" />
				<el-table-column prop="contactNumber" label="联系电话"  width="120" />
				<el-table-column :show-overflow-tooltip="true" prop="remarks" label="备注"  width="160" />
				</el-table>
		</div>
		<!-- 表尾分页显示 -->
